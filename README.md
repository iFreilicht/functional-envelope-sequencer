...
<a href="https://www.desmos.com/calculator/f1qmre2ilz"><img src="img/simple-envelope.png"></a>
...
Click on the image to open an interactive version and adjust the $a$ (attack), $d$ (decay) and $s$ (shape) values to get a feel for how this all works. You can see that the frequency of this waveform doesn't change when the inputs are adjusted. You can also see that this implementation is not procedural, but mathematical, which makes this concept powerful in multiple ways:
